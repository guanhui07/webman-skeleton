...
return [
    ...
    'aliyun' => [
        ...
        'access_key' => 'LTAI5tQ5aV8Ta9a9xejSgV3B',
        'access_secret' => 'gzd7D22vkGQCZTD2zZtf8Z9LCKPlnf',
        'sign_name' => '幻壤',
        'actions' => [
            ...
            'test' => [
                'actions_name' => '验证码短信',
                'template_id' => 'SMS_248190095',
            ],

            //验证码${code}，您正在注册成为新用户，感谢您的支持！
            'register' => [
                'actions_name' => '注册',
                'template_id' => 'SMS_248185128',
            ],

            //验证码${code}，您正在登录，若非本人操作，请勿泄露。
            'login' => [
                'actions_name' => '登录',
                'template_id' => 'SMS_247100041',
            ],
