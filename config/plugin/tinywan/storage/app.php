...
return [
    'enable' => true,
    'storage' => [
        'default' => 'qiniu', // local：本地 oss：阿里云 cos：腾讯云 qos：七牛云
        ...
        'qiniu' => [
            ...
            'accessKey' => 'BoR5zSe5chTjsmJ427wWQWd5CrM-fgfQjlwpFIod',
            'secretKey' => '-BY8m7OVsGOk1tXRguNvv7ZOsnBabsBrBoZlGiip',
            'bucket' => 'yijiantea',
            'dirname' => 'tea',
            'domain' => 'https://img.yijiantea.cn',
        ],
    ],
];
